...
public class Permission {
    ...
    public static void checkIn(int day){
        ...
        else if(day < 1 || day > 7) throw new RuntimeException("The input " + day + " is not represent any day!!!");
        else System.out.println("user is allowed to check in 10 AM to 3 PM");
